#!/usr/bin/env python3
"""
Simple Startup Script for Gap Screener
Starts app without auto-starting background scanner
"""
...
def start_app_without_scanner():
    """Start the Flask app without auto-starting background scanner"""
    print("🚀 Starting Flask app (without auto-starting background scanner)...")
...
def main():
    ...
    print("🎯 Gap Screener - Simple Startup")
    print("=" * 40)
    ...
    # Start the app without auto-starting background scanner
    app_process = start_app_without_scanner()
